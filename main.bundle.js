...
var ExistingUserComponent = (function () {
    ...
    ExistingUserComponent.prototype.ngOnInit = function () {
        ...
        this.testStatusObject['survey'] = {
            ...
            'description': 'An survey of some non-identifying details about you such as age, games played, rank etc..'
        };
...
module.exports = "<div class=\"existing-user\">\r\n  <p>\r\n    Welcome back, friend!<br>Here is your Participant ID: <span class=\"user-id\">{{id}}</span><br>\r\n    Below is a list of the tests required for this study, please try to do as many as you can, it would help us immensely!<br>\r\n    However, <span class=\"important\">the most important thing</span> is to first fill in the first form from the list so we can associate your test results with your in-game accounts and ability.\r\n  </p>\r\n  <ul class=\"test-list\">\r\n    <app-test-detail *ngFor=\"let testStatus of testStatuses\" [testStatus]=\"testStatus\" [id]=\"id\">\r\n    </app-test-detail>\r\n  </ul>\r\n</div>\r\n"
...
module.exports = "<div *ngIf=\"displayWelcomeMessage\" class=\"new-user\">\r\n  <p>Hello, you are asked to participate in an experiment carried out by the University of York. Currently the tests and website only exist in English but in future we hope to add more languages.</p>\r\n  <p>\r\n    Here is your personal ID: <span class=\"user-id\">{{id}}</span>\r\n  </p>\r\n  <p>\r\n    This ID will be stored in a cookie on your computer so you can return to our tests if you want to stop part-way through the tests.\r\n    The cookie will contain only your ID and which tests you have completed. If you don't want to use this cookie, or want to use a different computer, please note this ID down before proceeding, then you can delete the cookie.\r\n  </p>\r\n  <p>We are trying to see if there’s a link between Visuospatial Abilities (the ability to manipulate objects in your head), Reaction Times ( how fast you respond to things) and some aspects of your personality and how well you play video games. We are examining the following videogames : Dota 2 , League of Legends, CS:GO, Starcraft 2 and Tekken 7. It’s okay if you have played multiple games - we will ask you about each one individually.</p>\r\n  <p>\r\n      We want to preserve your privacy. We will not ask you for personal information like your name, address or email. If you are not feeling comfortable with a question that is asked, you are welcome to skip it. If you answer a question please be as truthful as possible. \r\n  </p>\r\n  <p>\r\n      Your data will be encrypted, anonymized and no identifying information will be shared outside the University of York. \r\n  </p>\r\n  <p>\r\n      You don’t have to be a pro Esports player to participate in our sample. The only requirement we have is that you are at least 18 years old.\r\n  </p>\r\n  <a routerLink=\"/existing-user/{{id}}\">Onwards, to psychology!</a>\r\n</div>\r\n<div *ngIf=\"!displayWelcomeMessage\" class=\"loading-message\">\r\n  <h3>Loading...</h3>\r\n</div>"
